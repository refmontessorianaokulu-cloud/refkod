  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-green-50 to-teal-50">
      ...
      <a
        ...
        className="fixed bottom-6 right-2 lg:right-6 z-50 flex items-center justify-center w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110 group"
