              ...
              <div className={`mt-3 ${openMobileCard === 'login' ? 'block' : 'hidden'}`}>
                {isGoogleAuthLoading ? (
                  <div className="text-center py-8">
                    <div className="inline-block animate-spin rounded-full h-8 w-8 border-2 border-green-600 border-t-transparent mb-3"></div>
                    <p className="text-sm text-gray-700">Google ile giriş yapılıyor...</p>
                  </div>
                ) : (
                  <>
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="w-full flex items-center justify-center gap-2 bg-white border-2 border-gray-300 text-gray-700 py-2 rounded-lg font-semibold hover:bg-gray-50 hover:border-gray-400 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm text-sm"
                    >
