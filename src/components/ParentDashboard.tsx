...
import { Baby, UtensilsCrossed, Moon, Calendar, BookOpen, Image as ImageIcon, Megaphone, MessageSquare, CalendarCheck, Car, X, CalendarPlus, UserCheck, MapPin, CreditCard, Home, Info, Sparkles, GraduationCap, Briefcase, Palette, AlertCircle, Search as SearchIcon, FileCheck } from 'lucide-react';
...
import FieldTripConsentsSection from './FieldTripConsentsSection';
...
const parentMenuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'ref_evaluation', label: 'REF Değerlendirme Sistemi', icon: Sparkles },
